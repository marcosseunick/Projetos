...
frame_corpo.bind("<Key-c>", lambda event: entrar_valores("c"))
...
frame_corpo.bind("<Key-%>", lambda event: entrar_valores("%"))
...
frame_corpo.bind("<Key-7>", lambda event: entrar_valores("7"))
...
frame_corpo.bind("<Key-8>", lambda event: entrar_valores("8"))
...
frame_corpo.bind("<Key-9>", lambda event: entrar_valores("9"))
...
frame_corpo.bind("<Key-4>", lambda event: entrar_valores("4"))
...
frame_corpo.bind("<Key-5>", lambda event: entrar_valores("5"))
...
frame_corpo.bind("<Key-6>", lambda event: entrar_valores("6"))
...
frame_corpo.bind("<Key-1>", lambda event: entrar_valores("1"))
...
frame_corpo.bind("<Key-2>", lambda event: entrar_valores("2"))
...
frame_corpo.bind("<Key-3>", lambda event: entrar_valores("3"))
...
frame_corpo.bind("<Key-0>", lambda event: entrar_valores("0"))
